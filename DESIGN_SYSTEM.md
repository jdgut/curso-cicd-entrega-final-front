...
```css
--brand-primary: #003da5 --brand-secondary: #0052cc --brand-tertiary: #005ce6
  --brand-light: #f0f4ff --brand-lighter: #f8faff --brand-accent: #ff6b35
  --brand-ink: #1f2937 --brand-muted: #6b7280;
```
